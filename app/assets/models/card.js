...
let COLORS = [YELLOW, RED, BROWN, BLUE, GREEN, GRAY, PURPLE];

let MANUFACTURED_GOODS = [GLASS, LOOM, PAPYRUS];

let TABLET = "tablet";
let COMPASS = "compass";
let WHEEL = "wheel";

let SCIENTESTS_GUILDS = [TABLET, COMPASS, WHEEL];
...
let VICTORY_POINT = "victory point";

let RAW_GOODS = [ORE, WOOD, CLAY, STONE];
let SHIELD = "shield";
